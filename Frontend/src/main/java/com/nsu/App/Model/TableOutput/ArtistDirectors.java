...
public class ArtistDirectors implements Table {
    final String request = "select FIRST_NAME, SECOND_NAME, MIDDLE_NAME, START_CONTRACT, END_CONTRACT, " +
            "EXPERIANCE, SEX, DATE_OF_BIRTH, NUMBER_OF_CHILDREN, SALARY\n" +
            "from employees e\n" +
            "join ARTIST_DIRECTORS ad on ad.ID_ARTIST_DIRECTOR = e.ID_EMPLOYEE";
